...
export const ButtonVariants = cva(
	'py-1 px-2 border-solid text-Grey-Grey-10 active:text-Grey-Grey-600T60 p-2 flex items-center justify-center',
	{
		variants: {
			theme: {
				primary:
				...
				secondary:
					'bg-Grey-Grey-800 border-Primary-White text-Primary-White active:bg-Primary-Black active:text-Grey-Grey-100 active:border-Grey-Grey-300T40',
			},
			size: {
				small: 'w-fit h-fit min-w-16 min-h-8 text-xl border-2',
				large: 'w-fit h-fit min-w-28 min-h-14 text-4xl border-2',
				full: 'w-full h-fit min-h-24 text-6xl  border-4',
			},
			radius: {
